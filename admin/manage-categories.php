...
<section class="dashboard">
    ...
    <?php endif ?>
    <?php if(isset($_SESSION['add-category'])):// shows if add category was not successful ?> 
    ...
    <div class="container dashboard__container">
        ...
        <aside>
           <ul>
            ...
            <li><a href="index.php"><i class="uil uil-plus"></i>
                <h5>Manage Posts</h5>
            </a></li>
            <?php if(isset($_SESSION['user_is_admin'])){?>
            <li><a href="add-user.php"><i class="uil uil-postcard"></i>
                <h5>Add User</h5>
            </a></li>
            <li><a href="manage-users.php"><i class="uil uil-edit"></i>
                <h5>Manage User</h5>
            </a></li>
