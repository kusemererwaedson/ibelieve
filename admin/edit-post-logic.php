...
//make sure post button was clicked
if(isset($_POST['submit'])){
    ...
    if(!$title){
        $_SESSION['edit-post'] = "Couldn't update post. Input the title";
    }elseif(!$category_id){
        $_SESSION['edit-post'] = "Couldn't update post. Input the category";
    }elseif(!$body){
        $_SESSION['edit-post'] = "Couldn't update post. Input the body";
    }
    else{
